...
import { User, Mail, Shield, School, Calendar, Sun, Moon } from 'lucide-react'
                    ...
                    <div className="bg-white dark:bg-slate-800 rounded-3xl shadow-xl shadow-slate-200/50 dark:shadow-none p-6 flex flex-col items-center text-center border border-slate-100 dark:border-slate-700">
                        <div className="w-24 h-24 rounded-full bg-gradient-to-br from-blue-500 to-indigo-600 p-1 mb-4">
                            <div className="w-full h-full rounded-full bg-white dark:bg-slate-800 flex items-center justify-center overflow-hidden">
                                <img
                                    src={`https://api.dicebear.com/7.x/micah/svg?seed=${userProfile?.email}&backgroundColor=b6e3f4`}
                                    alt="avatar"
